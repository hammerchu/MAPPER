#!/bin/bash
#
# Use this script to update the map list (map_list.json)
#
source_folder="/Users/hammerchu/Desktop/DEV/OBB/MAPPER/src/assets/maps"
destination_folder="/Users/hammerchu/Desktop/DEV/OBB/MAPPER/src/assets/maps"
exclusion_list=("BACKUP" ".json" ".sh" ".py" )
